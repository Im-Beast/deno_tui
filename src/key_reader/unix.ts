...
// This module works on Linux and macOS

import type { Alphabet, Key, KeyPress, MousePress } from "./types.ts";
 ...
 */
export function* decodeUnixBuffer(buffer: Uint8Array): Generator<KeyPress | MousePress, void, void> {
